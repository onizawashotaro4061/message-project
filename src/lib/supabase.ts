...
export const CARD_STYLES: CardStyle[] = [
  ...
  // 背景画像
  {
  id: 'meidaisai-pattern',
  name: '明大祭ロゴ',
  bgGradient: 'bg-white',
  borderColor: 'border-gray-200',
  textColor: 'text-gray-800',
  backgroundImage: '/images/meidaisai-pattern.png',
  ...
  borderColor: 'border-gray-200',
  textColor: 'text-gray-800',
  backgroundImage: 'https://images.unsplash.com/photo-1615800098799-0ccb261b1f92?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80?w=400&q=65',
  hasBackgroundImage: true,
},
  // 所属専用カード
  {
